...
<h1 style="margin:0 0 16px; font-size:24px; line-height:32px; font-weight:700; color:#1b1b1b;">
    ${msg("etapeEmailPasswordResetTitle")}
</h1>
<p style="margin:0;">${msg("etapeEmailPasswordResetIntro")}</p>
<@layout.button href=link label=msg("etapeEmailPasswordResetCta") />
