...
export type FooterLink = {
  ...
  /**
   * Destination. `undefined` pour un intitulé dont la page n'existe pas encore :
   * il est alors rendu en texte inerte, et non en `href="#"`. Un lien mort n'est
   * pas conforme au RGAA et trompe l'usager qui parcourt la page au clavier.
   *
   * TODO — routes à créer, puis renseigner le `href` correspondant :
   * « Glossaire » → /glossaire, « Mentions légales » → /mentions-legales,
   * « CGU » → /cgu, « Accessibilité » → /accessibilite.
   */
